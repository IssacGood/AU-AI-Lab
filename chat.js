...
var css = [
  ...
  ".cf-row.me .cf-recall-btn{border-color:#4ade80;color:#4ade80;background:rgba(0,0,0,.15)}",
  ".cf-row.me .cf-recall-btn:hover{background:#22c55e;color:#fff;border-color:#22c55e}",
